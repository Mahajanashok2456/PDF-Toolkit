...
router.post('/', upload.single('pdf'), async (req, res) => {
  try {
    ...
    const degreesValue = parseInt(angle || rotation || 90);
    if (isNaN(degreesValue) || degreesValue % 90 !== 0) {
      throw new PDFProcessingError('Rotation must be a multiple of 90 degrees', 400);
    }
